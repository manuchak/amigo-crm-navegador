...
const CallStatusFilter: React.FC<CallStatusFilterProps> = ({
  ...
  const callStatuses = [
    ...
    { id: 'no-answer', label: 'Sin Respuesta', color: 'bg-amber-100 border-amber-400 text-amber-700', icon: <Phone className="h-3.5 w-3.5 text-amber-500" /> },
    { id: 'busy', label: 'Ocupado', color: 'bg-yellow-100 border-yellow-400 text-yellow-700', icon: <Phone className="h-3.5 w-3.5 text-yellow-500" /> },
    { id: 'failed', label: 'Fallida', color: 'bg-red-100 border-red-400 text-red-700', icon: <Phone className="h-3.5 w-3.5 text-red-500" /> },
    { id: 'contacted', label: 'Contactado', color: 'bg-blue-100 border-blue-400 text-blue-700', icon: <Phone className="h-3.5 w-3.5 text-blue-500" /> },
  ];
