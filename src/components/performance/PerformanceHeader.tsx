...
interface PerformanceHeaderComponentProps {
...
// Renamed to PerformanceFilterHeader to avoid name collision with the imported PerformanceHeader
...
}: PerformanceHeaderComponentProps) {
